                ...
                child: SingleChildScrollView(
                    child: Column(
                      ...
                      Align(
                          ...
                          child: Padding(
                              padding: getPadding(left: 12, top: 26, right: 12),
                              child: Row(
                                  mainAxisAlignment:
                      ...
                      Align(
                          alignment: Alignment.centerLeft,
                          child: Padding(
                              padding: getPadding(left: 50, top: 15, right: 50),
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
